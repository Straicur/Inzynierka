...
class getNelmioApiDoc_Describers_ConfigService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_api_doc.describers.config'] = new \Nelmio\ApiDocBundle\Describer\ExternalDocDescriber(['info' => ['title' => 'LiteraVoxService', 'description' => 'This is service for LiteraVox application', 'version' => '1.0.0']]);
    }
}
