 ...
 */
final class Version20211018184450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_BC0317325E237E06');
        $this->addSql('CREATE TEMPORARY TABLE __temp__Institution AS SELECT institution_id, name, email, telephone, max_users, max_admins FROM Institution');
        $this->addSql('DROP TABLE Institution');
        $this->addSql('CREATE TABLE Institution (institution_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(180) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, telephone VARCHAR(255) NOT NULL COLLATE BINARY, max_users INTEGER NOT NULL, max_admins INTEGER NOT NULL)');
        $this->addSql('INSERT INTO Institution (institution_id, name, email, telephone, max_users, max_admins) SELECT institution_id, name, email, telephone, max_users, max_admins FROM __temp__Institution');
        $this->addSql('DROP TABLE __temp__Institution');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_BC0317325E237E06 ON Institution (name)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__Institution AS SELECT institution_id, name, email, telephone, max_users, max_admins FROM Institution');
        $this->addSql('DROP TABLE Institution');
        $this->addSql('CREATE TABLE Institution (institution_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(180) NOT NULL, email VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, max_users VARCHAR(255) NOT NULL COLLATE BINARY, max_admins VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO Institution (institution_id, name, email, telephone, max_users, max_admins) SELECT institution_id, name, email, telephone, max_users, max_admins FROM __temp__Institution');
        $this->addSql('DROP TABLE __temp__Institution');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_BC0317325E237E06 ON Institution (name)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__adminPassword AS SELECT admin_id, admin_password, created_at FROM adminPassword');
